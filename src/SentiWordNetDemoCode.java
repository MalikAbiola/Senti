...
public class SentiWordNetDemoCode {
    ...
    public double extract(String word, String pos) {
        return dictionary.get(word + "#" + pos) == null ? 0.00 : dictionary.get(word + "#" + pos);
    }
...
//        System.out.println("really#r " + sentiwordnet.extract("really", "r"));
//        System.out.println("really#r " + sentiwordnet.extract("really", "r"));
        //a-adjectives, n- nouns, r- adverbs, v- verbs
        System.out.println("good#n " + sentiwordnet.extract("fragile", "a"));
//        System.out.println("good#a " + sentiwordnet.extract("good", "a"));
//        System.out.println("good#a " + sentiwordnet.extract("devilishly", "r"));
//        System.out.println("not#r " + sentiwordnet.extract("nonabsorbent", "a"));
//        System.out.println("great#r " + sentiwordnet.extract("great", "a"));
    }
}
